...
<aside>
    <nav id="nav">
        <ul>
            <li><a  data-target="Admin_home/home"><i class="fas fa-home" ></i><div class="list-item">Home</div></a></li>
        </ul>
        <p >Manage Map</p>
        <ul>
        ...
        <ul>
            <li><a  data-target="Admin/home"><i class="fas fa-id-badge"></i><div class="list-item">Admins</div></a></li>
