...
<body>
<input type="text" class="form-control" list="places"  id="origin-input" placeholder="Your location" style="width:200px;"/>
<datalist id="places"></datalist>
<input type="text" class="form-control" id="location_type" placeholder="Choose place type" style="width:200px;">
